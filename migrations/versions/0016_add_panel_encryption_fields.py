...
down_revision: Union[str, None] = '0015_add_panel_type'
...
def upgrade() -> None:
    ...
    op.alter_column('panels', 'api_key',
                    existing_type=sa.String(255),
                    type_=sa.Text(),
                    existing_nullable=False)
    
    # Make node_id nullable with default 0 (for Marzban)
    op.alter_column('panels', 'node_id',
    ...
    op.add_column('panels', sa.Column('inbound_tag', sa.String(length=100), nullable=True, server_default='SUSH'))
