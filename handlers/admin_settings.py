...
def get_category_keyboard() -> InlineKeyboardMarkup:
    ...
    for cat in SettingCategory:
        buttons.append([InlineKeyboardButton(cat.value, callback_data=f"cfg_cat_{cat.name}")])
    buttons.append(
        [
...
def get_settings_keyboard(
    ...
    for s in sorted(settings, key=lambda x: x.key):
        ...
        buttons.append([InlineKeyboardButton(label, callback_data=f"cfg_edit_{s.key}")])
